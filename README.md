...
| A rollout-free solver finds Heart lines MCTS misses | **Refuted.** Exhaustive-within-turn DFS + 150-wide multi-objective beam, clairvoyant, no heuristic rollout anywhere: wins exactly the fights MCTS wins, none it loses. With 6/12 decks lost on all six shuffles, those fights are unwinnable from the given state, not mispiloted |
